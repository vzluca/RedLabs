...
| `main.js` | Nav, barra de progreso de scroll, scroll-storytelling, demo de chat, ensamblado del isotipo |
| `hero3d.js` | Escena WebGL del hero: isotipo que se ensambla + campo de puntos y líneas finas que convergen en la marca, con un pulso de señal cada tanto (carga diferida; fallback estático si no hay WebGL o hay `prefers-reduced-motion`) |
